    ...
    function showMessageModalDialog(message){
    ...
    function submitReturnOrderForm(){
        ...
        setReturnOrderRequest(reason,note);
        return false;
    }

    function setReturnOrderRequest(reason,note){
